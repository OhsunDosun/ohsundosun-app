...
part 'find_password_provider.g.dart';
...
Future<void> onNewPassword(BuildContext context, WidgetRef ref) async {
...
Future<void> onSignIn(BuildContext context, WidgetRef ref) async {
  ...
  try {
    ...
    ref.read(appSignInTypeProvider.notifier).update(SignInType.newPasswordSignIn);
